...
//  NumeroTests
//
//  Created by Luann Marques Luna on 03/02/21.
...
class ConverterTests: XCTestCase {
    ...
    func testConversionForTwentyEight() {
        let result = converter.convert(28)
        
        XCTAssertEqual(result, "XXVIII", "Conversion for 25 is incorrect")
    }
